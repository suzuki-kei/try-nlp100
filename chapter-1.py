...
def _generate_ngram_from_words(
    ...
    """
        ...
        ------
        ngram : str
            words に含まれる各単語を n 文字ずつに分割することで生成した N-gram.

        Examples
        --------
        >>> list(_generate_ngram_from_words(1, []))
        []
        >>> list(_generate_ngram_from_words(1, ['abc', 'de']))
        ['a', 'b', 'c', 'd', 'e']
        >>> list(_generate_ngram_from_words(2, ['abc', 'de']))
        ['ab', 'bc', 'de']
        >>> list(_generate_ngram_from_words(3, ['abc', 'de']))
        ['abc']
    """
    for word in words:
...
def _generate_ngram_from_text(
    ...
    """
        ...
        ------
        ngram : str
            text に含まれる各単語を n 文字ずつに分割することで生成した N-gram.

        Examples
        --------
        >>> list(_generate_ngram_from_text(1, ''))
        []
        >>> list(_generate_ngram_from_text(1, 'abc de'))
        ['a', 'b', 'c', 'd', 'e']
        >>> list(_generate_ngram_from_text(2, 'abc de'))
        ['ab', 'bc', 'cd', 'de']
        >>> list(_generate_ngram_from_text(3, 'abc de'))
        ['abc', 'bcd', 'cde']
    """
